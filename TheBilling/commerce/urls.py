...
urlpatterns = [
    ...
    path('services/<int:fkey>/prices/', cviews.ServicePricesList.as_view(), name='service_price_list_url_name'),
    path('services/<int:fkey>/price/delete/<int:pk>/', cviews.ServicePriceDelete.as_view(),
         name='service_price_delete_url_name'),
    path('services/<int:fkey>/price/create/', cviews.ServicePriceCreate.as_view(),
         name='service_price_create_url_name'),
    path('services/<int:fkey>/price/update/<int:pk>/', cviews.ServicePriceUpdate.as_view(),
         name='service_price_update_url_name'),

    path('Contract/<int:fkey>/services/', cviews.ContractServiceList.as_view(),
         name='contract_service_list_url_name'),
    path('Contract/<int:fkey>/service/create/', cviews.ContractServiceCreate.as_view(),
         name='contract_service_create_url_name'),
