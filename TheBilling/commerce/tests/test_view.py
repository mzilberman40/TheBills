...
class ProjectViewTests(TestCase):
    ...
    def test_project_get_list(self):
        url = reverse('commerce:project_list_url')
    ...
    def test_project_create_view_get(self):
        ...
        url = reverse('commerce:project_create_url')
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, template_name)
    ...
    def test_project_update_view_get(self):
        ...
        url = reverse('commerce:project_update_url', args=[self.project.pk])
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, template_name)
    ...
    def test_project_details_view_get(self):
        ...
        url = 'commerce:project_details_url'
